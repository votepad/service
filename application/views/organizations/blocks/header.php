...
<header class="header">
    <div class="header_wrapper">
        ...
        <a href="<?=URL::site('organization/' . $organization->id); ?>" title="На страницу организации: <?=$organization->name; ?>" class="header_text header_text-logo">Votepad</a>
        ...
        <div class="header_menu">
            ...
            <a class="header_button" href="<?=URL::site($organization->website .'/event/new'); ?>">
