...
<div class="block col-sm-12" style="height:200px; padding: 0; background-image: url(<?=$assets; ?>img/how_to_create_scenario.gif); background-position:center;background-repeat: no-repeat;">
...
<form method="POST" action="" id="result" enctype="multipart/form-data">
    ...
    <div class="form" id="result_group">
        <div class="form_body">
            <div class="row">
            <div class="col-sm-12">
                <div class="input-field">
