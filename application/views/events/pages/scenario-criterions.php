...
<div class="block">
    ...
    <div class="block__wrapper pt-10 fs-0_9">
        Название критерия - точное и краткое описание критерия. Описание критерия - дополнительная информация,
        которая будет необходима представителю жюри, для выставления балла.
    </div>
