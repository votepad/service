...
<div id="resultParticipantsArea" class="hide">
    ...
    <div class="block">
        <div class="block__wrapper pt-10 fs-0_9 t-lh-1_4">
            <p class="mb-5">
                Результаты будут публиковаться на странице мероприятия, вы можете опубликовать их как сразу все, так и по мере необходимости.
                Для публикации баллов нажмите на кнопку "опубликовать" в нужном блоке
            </p>
            <ul class="mb-0">
                <li>
                    <b>этап</b>: необходимо нажать на название этапа в конкретном конкурсе. Баллы публикуются на стринице подробного рейтинга.
                </li>
                <li>
                    <b>конкурс</b>: необходимо нажать на кнопку "итого" в конкретном конкурсе. Баллы публикуются на стринице подробного рейтинга.
                </li>
                <li>
                    <b>финальный результат</b>: баллы публикуются на главной стринице мероприятия.
                </li>
            </ul>
        </div>
    </div>
