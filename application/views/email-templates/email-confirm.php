                        ...
                        <td align="left" valign="top" style="vertical-align:top;text-align:left;padding: 15px 0;">
                            <table width="100%" style="border-spacing: 0;border: 15px solid #008DA7;">
                                <tbody>
                                                ...
                                                <tbody>
                                                    <tr align="left" style="text-align:left;">
                                                        ...
                                                        <td style="vertical-align:middle;line-height:1.5em" align="left" valign="middle">
                                                            Для активации аккаунта, пожалуйста, <a href="<?= $_SERVER['HTTP_HOST'].'/user/confirm/'.$hash ?>" style="text-decoration: none;color: #008DA7;padding-bottom: 2px;border-bottom: 2px solid #008DA7;">подтвердите регистрацию</a> на сайте votepad.ru.
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <tr align="left" style="text-align:left;">
                                        <td align="left" valign="top" style="vertical-align:top;text-align:left;background:#ffffff;padding: 35px;">
                                            <a href="<?= $_SERVER['HTTP_HOST'].'/user/confirm/'.$hash ?>" style="display: block;border-radius: 3px;text-align: center;color: #FCFCFC;background: #008DA7;padding: 20px;font-size: 1.3em;text-decoration: none;cursor: pointer;">
                                    ...
                                    <tr align="left" style="text-align:left;">
                                        <td align="left" valign="top" style="vertical-align:top;text-align:left;background:#ffffff;padding: 0 35px; font-size: .9em">
                                            Если кнопка не работает, то перейдите по этой ссылке: <a href="<?= $_SERVER['HTTP_HOST'].'/user/confirm/'.$hash ?>" style="text-decoration: none;color: #008DA7;padding-bottom: 2px;border-bottom: 2px solid #008DA7;"><?= $_SERVER['HTTP_HOST'].'/user/confirm/'.$hash ?></a>
                                        </td>
                                    </tr>
