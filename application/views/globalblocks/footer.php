<div class="footer__wrapper">
    <div class="footer__block clearfix">
        <!--<div class="footer__nav fl_r">
            <a href="#" class="footer__text footer__link">О проекте</a>
            <a href="#" class="footer__text footer__link">Связь с командой</a>
            <a href="#" class="footer__text footer__link">Вопросы</a>
        </div>-->
    ...
    <div role="separator" class="footer__divider divider"></div>
    <div class="footer__block">
        ...
        <span class="footer__copyright footer__text fl_r">© 2016-2017  "Votepad.RU"</span>
        <a href="mailto:team@votepad.ru" class="footer__email footer__text footer__link fl_r">team@votepad.ru</a>
    </div>
</div>
