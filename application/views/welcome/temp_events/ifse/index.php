...
<head>
    ...
    <title>International Festival Of Social Entrepreneurship 2016 | Votepad.ru</title>
    <meta charset="utf-8">
    <link type="image/x-icon" rel="shortcut icon" href="<?=$assets; ?>img/welcome/TEMP_EVENTS/ifse_imgs/favicon.png" />
    ...
    <section>
        ...
        <div class="row landing-main_info grey_bg">
            <div class="col-xs-12 col-md-4 info-elem">
                <div class="info-elem_border">
                    ...
                    <span  class="info-elem_description">14 December 2016</span>
                    <span class="info-elem_description">11:00-18:30</span>
                </div>
            </div>
            <div class="col-xs-12 col-md-4 info-elem">
                <div class="info-elem_border">
        ...
        <div class="row event-description_form" style="padding:5%;">
            ...
            <div class="event-description_social">
                ...
                VK.Widgets.Group("vk_groups", {mode: 4, wide: 2, width: "300", height: "500", color1: '292D35', color2: '0097A7', color3: 'EEEEEE'}, 78760337);
                </script>
            </div>
        </div>
         ...
         <div class="footer_wrapper">
             <div class="footer_block clearfix">
                ...
                <div class="logo">
                    ...
                    <span class="logo-text">Automated counting of </span>
                    <span class="logo-text">voting results</span>
                </div>
                <div class="nav-main">
                    <a href="/#events" class="footer_btn toEvents">All events</a>
                    <a href="#" class="footer_btn ">About service</a>
                </div>
            </div>
        </div>
    </footer>
...
$(document).ready(function(){
    ...
    var template = ["<li><div class=\"name\">", //name
                "</div><div class=\"photo\" style=\"background-image:url(<?=$assets; ?>img/welcome/TEMP_EVENTS/ifse_imgs/site/", //photo
...
<!-- Yandex.Metrika counter -->   <script type="text/javascript"> (function (d, w, c) { (w[c] = w[c] || []).push(function() { try { w.yaCounter41510634 = new Ya.Metrika({ id:41510634, clickmap:true, trackLinks:true, accurateTrackBounce:true }); } catch(e) { } }); var n = d.getElementsByTagName("script")[0], s = d.createElement("script"), f = function () { n.parentNode.insertBefore(s, n); }; s.type = "text/javascript"; s.async = true; s.src = "https://mc.yandex.ru/metrika/watch.js"; if (w.opera == "[object Opera]") { d.addEventListener("DOMContentLoaded", f, false); } else { f(); } })(document, window, "yandex_metrika_callbacks"); </script> <noscript><div><img src="https://mc.yandex.ru/watch/41510634" style="position:absolute; left:-9999px;" alt="" /></div></noscript> <!-- /Yandex.Metrika counter -->
