var eventInfo = function (eventInfo) {
    ...
    eventInfo.changeType = function (element) {
        ...
        var ajaxData = {
            ...
            error: function(responce) {
                vp.core.log('ajax error occur on publishing event','error',corePrefix,responce);
                vp.form.removeLoadingClass(block);
            }
        };
    ...
    var submitForm_ = function (event) {
        ...
        var ajaxData = {
            ...
            error: function(responce) {
                vp.core.log('ajax error occur on updating event info','error',corePrefix,responce);
                vp.form.removeLoadingClass(form);
            }
        };
